...
Map<String, dynamic> _normalizeMatch(Map<String, dynamic> raw) {
  ...
  return {
    ...
    'other_user_age': _readInt(otherUser, ['age']) ,
    'other_user_niyyah': _readString(otherUser, ['niyyah']),
    'other_user_madhab': _readString(otherUser, ['madhab']),
    'other_user_city': _readString(otherUser, ['city']),
